export default {
  ...
  collectableStrategyLab: {
    ...
    analysis: {
      ...
      run: 'Run Analysis',
      running: 'Analyzing',
      runningDesc: 'Calculating the strategy results. Please wait.',
    ...
    editor: {
      ...
      calculatingNodes: 'Calculating nodes…',
